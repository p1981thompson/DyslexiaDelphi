...
\title{\Huge{\textbf{RECAP (v-1)}} \\ \qquad \\\textbf{\large{Remote COVID-19 Assessment for Primary Care (third round)}}}
...
require(readxl)
qualtrics.terminology.Test<-read_excel("/Volumes/PSYHOME/PSYRES/pthompson/DVMB/CREWS_delphi/test data/CREWS_terminology_r3.xlsx", sheet="CREWS_T",col_types='text')
...
##############################
  ...
  statements_T1_ind<-c(seq(8,55,2))
  comments_ind_T<-c(seq(9,56,2),56)
  
  contact.data.T<-qualtrics.terminology.Test[,1:6]
  #add.info2<-qualtrics.data.Test2[,7:19]
  #r.data<-
  v.data.T<-data.frame(matrix(0, nrow = dim(qualtrics.terminology.Test)[1], ncol = 24))
  comments.T<-data.frame(matrix(0, nrow = dim(qualtrics.terminology.Test)[1], ncol = 25))
...
delphi.Terminology.statements<-read_excel("/Volumes/PSYHOME/PSYRES/pthompson/DVMB/CREWS_delphi/test data/delphi terminology statements_r3.xlsx",sheet="delphi T statements2")
...
names(delphi.Term.combine)<-delphi.Terminology.statements[1:24,2]
...
<<results=tex,echo=FALSE>>=
  require(xtable)
  require(readxl)
delphi.T.comments<-read_excel("/Volumes/PSYHOME/PSYRES/pthompson/DVMB/CREWS_delphi/test data/CREWS_terminology_r3.xlsx",sheet="Comments")
...
\mysubsection{Heart rate (per minute)}{\small{Heart rate}}

<<results=hide,echo=FALSE>>=
source("/Volumes/PSYHOME/PSYRES/pthompson/DVMB/CREWS_delphi/reports/newfunsT.R")
delphi.statements<-read_excel("/Volumes/PSYHOME/PSYRES/pthompson/DVMB/CREWS_delphi/test data/delphi terminology statements_r3.xlsx",sheet="delphi T statements3")
...
for(i in 1:24){names(delphi.Term.combine3)[i]<-paste(strwrap(names(delphi.Term.combine3)[i], width = 150), collapse="\n")}
...
\mysubsection{RESPIRATORY SYMPTOMS AND SIGNS - Shortness of breath}{\small{Shortness of breath}}
...
\clearpage % Better use FloatBarrier here
%%statement 5%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\mysubsection{RESPIRATORY SYMPTOMS AND SIGNS - Respiratory rate}{\small{Respiratory rate}}
...
\clearpage % Better use FloatBarrier here
%%statement 7 %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\mysubsection{HYPOXIA - Oxygen saturation at rest}{\small{Oxygen saturation at rest}}
...
\clearpage % Better use FloatBarrier here
%%statement 9 %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\mysubsection{HYPOXIA - Oxygen saturation after walking 40 steps}{\small{Oxygen saturation after walking 40 steps}}
...
\mysubsection{RESPIRATORY SYMPTOMS AND SIGNS - OR Profound tiredness or fatigue}{\small{Profound tiredness or fatigue}}
...
\mysubsection{FEVER - Measured temperature}{\small{Measured temperature}}
...
\clearpage
%%statement 15 %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\mysubsection{FEVER - OR Feverish with shivers or chills}{\small{Feverish with shivers or chills}}
...
\clearpage
%%statement 19 %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\mysubsection{RISK FACTORS - Is patient on the covid-19 shelded list (or in your opinion, should they be)?}{\small{Is patient on the covid-19 shelded list}}
...
\clearpage
%%statement 21 %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\mysubsection{RISK FACTORS - Do they have other risk factors for poor outcome? }{\small{Do they have other risk factors for poor outcome?}}
...
%%statement 23 %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\mysubsection{Clinical Concern Component - After assessing the patient, what is your level of clinical concern (regardless of RECAP score)?}{\small{After assessing the patient, what is your level of clinical concern (regardless of RECAP score)?}}
