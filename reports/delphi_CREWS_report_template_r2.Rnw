...
\title{\Huge{\textbf{RECAP (v-1)}} \\ \qquad \\\textbf{\large{Remote COVID-19 Assessment for Primary Care (second round)}}}
...
require(readxl)
qualtrics.terminology.Test<-read_excel("/Volumes/PSYHOME/PSYRES/pthompson/DVMB/CREWS_delphi/test data/CREWS_terminology_r2.xlsx", sheet="CREWS_T",col_types='text')
...
##############################
  ...
  statements_T1_ind<-c(seq(8,51,2))
  comments_ind_T<-c(seq(9,52,2),52)
  
  contact.data.T<-qualtrics.terminology.Test[,1:6]
  #add.info2<-qualtrics.data.Test2[,7:19]
  #r.data<-
  v.data.T<-data.frame(matrix(0, nrow = dim(qualtrics.terminology.Test)[1], ncol = 22))
  comments.T<-data.frame(matrix(0, nrow = dim(qualtrics.terminology.Test)[1], ncol = 23))
...
delphi.Terminology.statements<-read_excel("/Volumes/PSYHOME/PSYRES/pthompson/DVMB/CREWS_delphi/test data/delphi terminology statements_r2.xlsx",sheet="delphi T statements2")
...
names(delphi.Term.combine)<-delphi.Terminology.statements[1:22,2]
...
<<results=tex,echo=FALSE>>=
  require(xtable)
  require(readxl)
delphi.T.comments<-read_excel("/Volumes/PSYHOME/PSYRES/pthompson/DVMB/CREWS_delphi/test data/CREWS_terminology_r2.xlsx",sheet="Comments")
...
\mysubsection{Red Flags (Urgent referral)}{\small{Urgent referral}}

<<results=hide,echo=FALSE>>=
source("/Volumes/PSYHOME/PSYRES/pthompson/DVMB/CREWS_delphi/reports/newfunsT.R")
delphi.statements<-read_excel("/Volumes/PSYHOME/PSYRES/pthompson/DVMB/CREWS_delphi/test data/delphi terminology statements_r2.xlsx",sheet="delphi T statements3")
...
for(i in 1:22){names(delphi.Term.combine3)[i]<-paste(strwrap(names(delphi.Term.combine3)[i], width = 150), collapse="\n")}
...
\clearpage % Better use FloatBarrier here
%%statement 5%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\mysubsection{RESPIRATORY SYMPTOMS AND SIGNS - Profound tiredness or fatigue}{\small{Profound tiredness or fatigue}}
...
\clearpage % Better use FloatBarrier here
%%statement 7 %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\mysubsection{RESPIRATORY SYMPTOMS AND SIGNS - Oxygen saturation at rest}{\small{Oxygen saturation at rest}}
...
\clearpage % Better use FloatBarrier here
%%statement 9 %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\mysubsection{RESPIRATORY SYMPTOMS AND SIGNS - Oxygen saturation after walking 40 steps}{\small{Oxygen saturation after walking 40 steps}}
...
\mysubsection{FEVER - Temperature as measured by patient or carer}{\small{Temperature as measured by patient or carer}}
...
\clearpage
%%statement 15 %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\mysubsection{FEVER - Feverish with shivers or chills}{\small{Feverish with shivers or chills}}
...
\clearpage
%%statement 17 %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\mysubsection{Heart rate (per minute)}{\small{Heart rate (per minute)}}
...
\clearpage
%%statement 19 %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\mysubsection{Known risk factors for poor outcome}{\small{Known risk factors for poor outcome}}
...
\clearpage
%%statement 21 %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\mysubsection{Clinical judgement}{\small{Clinical judgement}}
...
This copy of the RECAP v-1 Delphi results (round 2) has been supplied on the condition that anyone who consults it
