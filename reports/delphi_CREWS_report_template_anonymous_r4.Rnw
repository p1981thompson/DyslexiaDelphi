...
P6A <- ggplot(data.frame(RECAP_score=delphi.Term.combine[,6]),aes(x=factor(RECAP_score,levels=c(0:16))))+
...
P10A <- ggplot(data.frame(RECAP_score=delphi.Term.combine[,10]),aes(x=factor(RECAP_score,levels=c(0:16))))+
  geom_bar(aes(fill=RECAP_score,y = (..count..)/sum(..count..))) +
  geom_text(aes(y = ((..count..)/sum(..count..)), label = scales::percent((..count..)/sum(..count..))), stat = "count", vjust = -0.25) +
  labs(y = "Percent", x = "RECAP Score")+theme_bw()+theme(legend.position="none")+ scale_x_discrete(drop=FALSE)
...
P14A <- ggplot(data.frame(RECAP_score=delphi.Term.combine[,14]),aes(x=factor(RECAP_score,levels=c(0:16))))+
  geom_bar(aes(fill=RECAP_score,y = (..count..)/sum(..count..))) +
  geom_text(aes(y = ((..count..)/sum(..count..)), label = scales::percent((..count..)/sum(..count..))), stat = "count", vjust = -0.25) +
  labs(y = "Percent", x = "RECAP Score")+theme_bw()+theme(legend.position="none")+ scale_x_discrete(drop=FALSE)
...
P18A <- ggplot(data.frame(RECAP_score=delphi.Term.combine[,18]),aes(x=factor(RECAP_score,levels=c(0:16))))+
  geom_bar(aes(fill=RECAP_score,y = (..count..)/sum(..count..))) +
  geom_text(aes(y = ((..count..)/sum(..count..)), label = scales::percent((..count..)/sum(..count..))), stat = "count", vjust = -0.25) +
  labs(y = "Percent", x = "RECAP Score")+theme_bw()+theme(legend.position="none")+ scale_x_discrete(drop=FALSE)
...
P22A <- ggplot(data.frame(RECAP_score=delphi.Term.combine[,22]),aes(x=factor(RECAP_score,levels=c(0:16))))+
  geom_bar(aes(fill=RECAP_score,y = (..count..)/sum(..count..))) +
  geom_text(aes(y = ((..count..)/sum(..count..)), label = scales::percent((..count..)/sum(..count..))), stat = "count", vjust = -0.25) +
  labs(y = "Percent", x = "RECAP Score")+theme_bw()+theme(legend.position="none")+ scale_x_discrete(drop=FALSE)
