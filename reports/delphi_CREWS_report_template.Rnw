...
<<results=tex,echo=FALSE>>=
  require(xtable)
  require(readxl)
delphi.T.comments<-read_excel("H:\\DVMB\\CREWS_delphi\\test data\\CREWS_terminology.xlsx",sheet="Comments")
...
if(is.na(delphi.Term.combine2[delphi.Term.combine2$username==panel.member,2,drop=FALSE])==FALSE){likert.density.plot3(Q1A, type="density",legend.position="bottom",wrap=110) + geom_vline(xintercept = delphi.Term.combine.N[delphi.Term.combine2$username==panel.member,1], colour = "red", size=1.5)+theme_bw()+ theme(legend.position="none", axis.text.x = element_text(angle = 30, hjust = 1))}
@
...
likert.density.plot3(Q3A, type="density",legend.position="bottom",wrap=110) + geom_vline(xintercept = delphi.Term.combine.N[delphi.Term.combine2$username==panel.member,3], colour = "red", size=1.5)+theme_bw()+ theme(legend.position="none", axis.text.x = element_text(angle = 30, hjust = 1))}
@
...
likert.density.plot3(Q5A, type="density",legend.position="bottom",wrap=110)+ geom_vline(xintercept = delphi.Term.combine.N[delphi.Term.combine2$username==panel.member,5], colour = "red", size=1.5) +theme_bw()+ theme(legend.position="none", axis.text.x = element_text(angle = 30, hjust = 1))}
@
...
likert.density.plot3(Q7A, type="density",legend.position="bottom",wrap=110)+ geom_vline(xintercept = delphi.Term.combine.N[delphi.Term.combine2$username==panel.member,7], colour = "red", size=1.5) +theme_bw()+ theme(legend.position="none", axis.text.x = element_text(angle = 30, hjust = 1))}
@
...
likert.density.plot3(Q9A, type="density",legend.position="bottom",wrap=110) + geom_vline(xintercept = delphi.Term.combine.N[delphi.Term.combine2$username==panel.member,9], colour = "red", size=1.5)+theme_bw()+ theme(legend.position="none", axis.text.x = element_text(angle = 30, hjust = 1))}
@
...
likert.density.plot3(Q11A, type="density",legend.position="bottom",wrap=110) + geom_vline(xintercept = delphi.Term.combine.N[delphi.Term.combine2$username==panel.member,11], colour = "red", size=1.5)+theme_bw()+ theme(legend.position="none", axis.text.x = element_text(angle = 30, hjust = 1))}
@
...
likert.density.plot3(Q13A, type="density",legend.position="bottom",wrap=110) + geom_vline(xintercept = delphi.Term.combine.N[delphi.Term.combine2$username==panel.member,13], colour = "red", size=1.5)+theme_bw()+ theme(legend.position="none", axis.text.x = element_text(angle = 30, hjust = 1))}
@
...
likert.density.plot3(Q15A, type="density",legend.position="bottom",wrap=110)+ geom_vline(xintercept = delphi.Term.combine.N[delphi.Term.combine2$username==panel.member,15], colour = "red", size=1.5) +theme_bw()+ theme(legend.position="none", axis.text.x = element_text(angle = 30, hjust = 1))}
@
...
likert.density.plot3(Q17A, type="density",legend.position="bottom",wrap=110)+ geom_vline(xintercept = delphi.Term.combine.N[delphi.Term.combine2$username==panel.member,17], colour = "red", size=1.5) +theme_bw()+ theme(legend.position="none", axis.text.x = element_text(angle = 30, hjust = 1))}
@
...
likert.density.plot3(Q19A, type="density",legend.position="bottom",wrap=110)+ geom_vline(xintercept = delphi.Term.combine.N[delphi.Term.combine2$username==panel.member,19], colour = "red", size=1.5) +theme_bw()+ theme(legend.position="none", axis.text.x = element_text(angle = 30, hjust = 1))}
@
...
likert.density.plot3(Q21A, type="density",legend.position="bottom",wrap=110)+ geom_vline(xintercept = delphi.Term.combine.N[delphi.Term.combine2$username==panel.member,21], colour = "red", size=1.5) +theme_bw()+ theme(legend.position="none", axis.text.x = element_text(angle = 30, hjust = 1))}
@
...
likert.density.plot3(Q23A, type="density",legend.position="bottom",wrap=110)+ geom_vline(xintercept = delphi.Term.combine.N[delphi.Term.combine2$username==panel.member,23], colour = "red", size=1.5) +theme_bw()+ theme(legend.position="none", axis.text.x = element_text(angle = 30, hjust = 1))}
@
...
likert.density.plot3(Q25A, type="density",legend.position="bottom",wrap=110)+ geom_vline(xintercept = delphi.Term.combine.N[delphi.Term.combine2$username==panel.member,25], colour = "red", size=1.5) +theme_bw()+ theme(legend.position="none", axis.text.x = element_text(angle = 30, hjust = 1))}
@
