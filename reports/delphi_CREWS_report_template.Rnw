...
delphi.Terminology.statements<-read.xlsx("/Volumes/PSYHOME/PSYRES/pthompson/DVMB/CREWS_delphi/test data/delphi terminology statements.xlsx",sheet="delphi T statements2")
